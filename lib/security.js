...
export async function isAdminUser() {
  try {
    ...
    try {
      ...
      // Clerk not properly configured - allow admin check to pass in development if .env.local has ADMIN_EMAILS set
      if (process.env.NODE_ENV === 'development') {
        console.warn('Clerk not configured, skipping auth in development')
